...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'filter.priceRange': { en: 'Price Range', ar: 'نطاق السعر' },
  'filter.minPrice': { en: 'Min', ar: 'أقل' },
  'filter.maxPrice': { en: 'Max', ar: 'أقصى' },
  'filter.rating': { en: 'Rating', ar: 'التقييم' },
  'filter.primeOnly': { en: 'Prime Only', ar: 'برايم فقط' },
  'filter.sortBy': { en: 'Sort By', ar: 'ترتيب حسب' },
  'filter.apply': { en: 'Apply Filters', ar: 'تطبيق' },
  'filter.clear': { en: 'Clear All', ar: 'مسح الكل' },
  'filter.filters': { en: 'Filters', ar: 'تصفية' },
  'sort.most_reviewed': { en: 'Most Reviewed', ar: 'الأكثر تقييماً' },
  'product.prime': { en: 'Prime', ar: 'برايم' },
  'product.buyNow': { en: 'Buy on Amazon.sa', ar: 'اشتر من أمازون' },
  'product.description': { en: 'Description', ar: 'الوصف' },
  'product.features': { en: 'Key Features', ar: 'المميزات' },
  'product.relatedProducts': { en: 'Related Products', ar: 'منتجات مشابهة' },
  'product.images': { en: 'Images', ar: 'الصور' },
  'product.availability': { en: 'Availability', ar: 'التوفر' },
  'product.brand': { en: 'Brand', ar: 'العلامة التجارية' },
  'search.results': { en: 'Search Results', ar: 'نتائج البحث' },
  'search.resultsFor': { en: 'Results for', ar: 'نتائج البحث عن' },
  'categories.all': { en: 'All Categories', ar: 'جميع الأقسام' },
  'categories.browse': { en: 'Browse by Category', ar: 'تصفح حسب القسم' },
  'home.featuredDeals': { en: 'Featured Deals', ar: 'عروض مميزة' },
  'home.topCategories': { en: 'Top Categories', ar: 'أهم الأقسام' },
  'home.whyUs': { en: 'Why SB Gamers?', ar: 'لماذا SB Gamers؟' },
};
